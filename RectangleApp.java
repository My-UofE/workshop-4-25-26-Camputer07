...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("\nmyRect4 overlaps myRect5: " + myRect4.isOverlappedWith(myRect5));
		...
		System.out.println("\nmyRect4 overlaps myRect6: " + myRect4.isOverlappedWith(myRect6));
		System.out.println("myRect6 overlaps myRect4: " + myRect6.isOverlappedWith(myRect4));

		// Use the new overlapping function
		boolean result = Rectangle.areOverlapping(myRect4, myRect5);
		System.out.println("\nmyRect4 overlaps myRect5: " + result);

		// Create a new square
		Rectangle square = new Rectangle(30.0, 30.0);
		System.out.println("Is square, square? " + square.isSquare());
	}
}
